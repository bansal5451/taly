...
const CompanyMasterPage = () => {
  ...
  return (
    ...
    <div className="min-h-140 bg-sky-200 p-2 text-[13px] font-sans">
      <div className="bg-yellow-400 relative bottom-11 right-2 h-7 w-40 text-center text-lg font-bold">Company Master</div>
       <div className="flex items-start gap-1 relative bottom-5">
          ...
          <h2 className="p-3 ml-15">List of Party Master</h2>
          </div>
      ...
      {/* Main Content */}
      <div className="flex h-175 relative bottom-5">
        {/* Left Sidebar */}
        <div className="w-70 bg-gray-400 relative h-175 mt-2 border-r overflow-y-auto ">
        ...
        <div className=" w-full flex-1 bg-yellow-50 h-170 p-4 grid grid-cols-2 gap-2 mt-8 relative right-27 text-sm">
          ...
          <div className="relative top-18 right-130">
            <label className="block mb-1 font-bold">Code:</label>
            <input type="text" className="w-45 p-1 bg-gray-100"  value={selectedParty} readOnly />
          </div>
          <div className="relative bottom-64">
            <label className="block mb-1 font-bold">City:</label>
            <input type="text" className="w-45 p-1 bg-gray-100"  />
          </div>
